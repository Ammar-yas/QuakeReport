    ...
    /*public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                *//*long timeInMili = properties.getLong("time");
                Date dateObject = new Date(timeInMili);
                SimpleDateFormat dateFormater = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss a");
                String dateToDisplay = dateFormater.format(dateObject);
                String time = dateToDisplay;
*//*
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        //Check the URL if null then return early
        if (url == null) {
            return jsonResponse;
        }
        ...
        try {
            ...
            //ig request was successful then read input stream then parse the response
    ...
    public static List<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        Log.e("fetchEarthquakeData", "started");
